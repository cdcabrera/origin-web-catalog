    ...
    var n = r(1), i = r(0), s = function() {
        function e(t, r, n, s, a, o, c) {
            ...
            this.ctrl = this, this.getProjectChoices = function() {
                ...
                return l.largeProjectList ? "" : e.metadata.uid ? l.RecentlyViewedProjectsService.isRecentlyViewed(e.metadata.uid) ? "Recently Viewed" : "Other Projects" : "";
        ...
        return e.prototype.$onInit = function() {
            ...
            }, n = i.reject(t, "metadata.deletionTimestamp");
            this.projects = this.RecentlyViewedProjectsService.orderByMostRecentlyViewed(n), 
